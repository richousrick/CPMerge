...
public class Helper {
	...
	private static final HashMap<String, String> completedSourceFiles = new HashMap<String, String>();
	private static boolean sourceLock = false;

	private static final ArrayList<MergedFunction<?>> updatedFunctions = new ArrayList<>();
