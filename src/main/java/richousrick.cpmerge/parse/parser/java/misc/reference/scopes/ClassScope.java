...
import richousrick.cpmerge.parse.parser.java.comp.JavaParser.ClassDeclarationContext;
import richousrick.cpmerge.parse.parser.java.comp.JavaParser.ConstructorDeclarationContext;
...
public class ClassScope extends Scope {
	...
	/*
	 * (non-Javadoc)
	 * @see richousrick.cpmerge.parse.parser.java.misc.Scope#getPath()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see richousrick.cpmerge.parse.parser.java.misc.Scope#resolveReferences()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * richousrick.cpmerge.parse.parser.java.misc.Scope#getInterfaceDeclaration(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see richousrick.cpmerge.parse.parser.java.misc.reference.scopes.Scope#getScopesToResolve()
	 */
	@Override
