...
import richousrick.cpmerge.parse.parser.java.comp.JavaParser.CompilationUnitContext;
...
public class FileScope extends Scope {
	...
	/*
	 * (non-Javadoc)
	 * @see richousrick.cpmerge.parse.parser.java.misc.Scope#typeDeclared(java.lang.String)
	 */
	@Override
