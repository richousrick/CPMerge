...
import richousrick.cpmerge.parse.parser.java.misc.reference.scopes.InnerScope;
...
public class ReflectedFunctionScope extends FunctionScope {
	 ...
	 * (non-Javadoc)
	 * @see
	 * richousrick.cpmerge.parse.parser.java.misc.reference.scopes.FunctionScope#getReturnType()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see richousrick.cpmerge.parse.parser.java.misc.reference.scopes.FunctionScope#getPublicity()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see richousrick.cpmerge.parse.parser.java.misc.reference.scopes.FunctionScope#getPath()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see richousrick.cpmerge.parse.parser.java.misc.reference.scopes.FunctionScope#toString()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * richousrick.cpmerge.parse.parser.java.misc.reference.scopes.FunctionScope#calculatePath()
	 */
	@Override
