...
import parse.parser.java.misc.reference.scopes.InterfaceDeclaration;
...
public class ReflectedClassScope extends ClassScope {
	...
	/*
	 * (non-Javadoc)
	 * @see parse.parser.java.misc.reference.scopes.Scope#getParent()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see parse.parser.java.misc.reference.scopes.ClassScope#getPath()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see parse.parser.java.misc.reference.scopes.ClassScope#
	...
	/*
	 * (non-Javadoc)
	 * @see parse.parser.java.misc.reference.scopes.ClassScope#getExtendsPath()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see parse.parser.java.misc.reference.scopes.ClassScope#getInterfaces()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see parse.parser.java.misc.reference.scopes.ClassScope#toString()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * parse.parser.java.misc.reference.scopes.Scope#getSymbol(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * parse.parser.java.misc.reference.scopes.ClassScope#isOfType(parse.parser.
